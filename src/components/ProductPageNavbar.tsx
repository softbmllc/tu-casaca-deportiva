    ...
    <header className="bg-white/50 backdrop-blur-md text-black fixed top-0 w-full z-50 shadow-sm py-0.5">
      ...
      <div className="flex sm:hidden items-center justify-between px-4 py-0.5">
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-1">
            <FaGlobe className="text-[#004AAD] w-4 h-4 drop-shadow-sm hover:drop-shadow-md transition-all duration-200" />
            <button onClick={() => i18n.changeLanguage('es')} className={`text-xs px-1 py-0.5 drop-shadow-sm hover:drop-shadow-md transition-all duration-200 ${i18n.language === 'es' ? 'font-semibold text-[#004AAD]' : 'text-[#004AAD]'}`}>ES</button>
            <button onClick={() => i18n.changeLanguage('en')} className={`text-xs px-1 py-0.5 drop-shadow-sm hover:drop-shadow-md transition-all duration-200 ${i18n.language === 'en' ? 'font-semibold text-[#004AAD]' : 'text-[#004AAD]'}`}>EN</button>
          </div>
          <Link to="/carrito" className="relative text-[#004AAD] drop-shadow-sm hover:drop-shadow-md transition-all duration-200">
          ...
          <button
            className="text-[#004AAD] drop-shadow-sm hover:drop-shadow-md transition-all duration-200"
      ...
      <div className="hidden sm:flex max-w-7xl mx-auto px-4 py-1 items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-1">
            <FaGlobe className="text-[#004AAD] w-4 h-4 drop-shadow-sm hover:drop-shadow-md transition-all duration-200" />
            <button onClick={() => i18n.changeLanguage('es')} className={`text-sm px-2 py-0.5 drop-shadow-sm hover:drop-shadow-md transition-all duration-200 ${i18n.language === 'es' ? 'font-semibold text-[#004AAD]' : 'text-[#004AAD]'}`}>ES</button>
            <button onClick={() => i18n.changeLanguage('en')} className={`text-sm px-2 py-0.5 drop-shadow-sm hover:drop-shadow-md transition-all duration-200 ${i18n.language === 'en' ? 'font-semibold text-[#004AAD]' : 'text-[#004AAD]'}`}>EN</button>
          </div>
          <Link to="/carrito" className="relative text-[#004AAD] drop-shadow-sm hover:drop-shadow-md transition-all duration-200">
            <ShoppingCart className="w-5 h-5" />
            {totalItems > 0 && (
