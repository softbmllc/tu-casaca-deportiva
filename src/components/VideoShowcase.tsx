...
export default function VideoShowcase() {
  ...
  return (
    <section className="bg-black pb-0 mb-0 pt-16 px-4 text-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {videoUrls.map((url, i) => (
            <div
              key={i}
              className={`overflow-hidden rounded-2xl border border-neutral-700 shadow-lg bg-black aspect-[9/16] transform transition-transform duration-300 hover:scale-105 opacity-0 animate-fadeIn`}
