...
export default function CategorySection() {
  ...
  return (
    <section
  id="catalogo"
  className="py-24 text-center scroll-mt-16 bg-black"
>
      <Helmet>
      ...
      <motion.p
        className="text-sm uppercase text-white/50 tracking-widest mb-3"
      ...
      <h2 className="text-4xl sm:text-5xl font-extrabold mb-12 text-white tracking-tight uppercase drop-shadow-[0_4px_12px_rgba(0,0,0,1)]">
        CATEGORÍAS
      </h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center p-6">
            <div className="flex items-center gap-2">
              <FaFutbol className="text-white text-2xl group-hover:text-[#00ffc8] transition-colors duration-300" />
              <motion.span
                initial={{ opacity: 0, y: 10 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, ease: 'easeOut' }}
                className="text-white text-3xl sm:text-4xl font-extrabold tracking-wide drop-shadow-[0_4px_12px_rgba(0,0,0,1)]"
              >
                FÚTBOL
              </motion.span>
            </div>
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center p-6">
            <div className="flex items-center gap-2">
              <FaBasketballBall className="text-white text-2xl group-hover:text-[#ffb347] transition-colors duration-300" />
              <motion.span
                initial={{ opacity: 0, y: 10 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, ease: 'easeOut' }}
