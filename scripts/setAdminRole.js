...
var setCustomUserClaim = function (email) { return __awaiter(void 0, void 0, void 0, function () {
    var user, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                _a.sent();
                console.log("\u2705 Usuario ".concat(email, " ahora tiene rol: admin"));
                return [3 /*break*/, 4];
            case 3:
                error_1 = _a.sent();
                console.error('❌ Error al asignar el rol:', error_1);
                return [3 /*break*/, 4];
